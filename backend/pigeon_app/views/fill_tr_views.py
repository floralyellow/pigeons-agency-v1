...
class FillTRView(APIView):
    ...
    def post(self, request):
        ...
        TR_Pigeon(lvl_expedition=1,coef_chance_rate=1,pigeon_type=1,src="test.png",name="pig1-1",min_atk=1,max_atk=11,min_life=3,max_life=33,min_shield=0,max_shield=0,speed=50,min_luck_1=50,effect_1_chance=[1,1,1],effect_1=[1,2,3],min_luck_2=80,effect_2_chance=[1,1],effect_2=[7,8],is_active=True),
        TR_Pigeon(lvl_expedition=2,coef_chance_rate=1,pigeon_type=1,src="test.png",name="pig1-2",min_atk=8,max_atk=19,min_life=24,max_life=57,min_shield=0,max_shield=0,speed=50,min_luck_1=50,effect_1_chance=[1,1,1],effect_1=[1,2,3],min_luck_2=80,effect_2_chance=[1,1],effect_2=[7,8],is_active=True),
        ...
        TR_Pigeon(lvl_expedition=1,coef_chance_rate=1,pigeon_type=2,src="test.png",name="pig2-1",min_atk=1,max_atk=11,min_life=3,max_life=33,min_shield=1,max_shield=3,speed=40,min_luck_1=70,effect_1_chance=[1,1,1],effect_1=[4,5,6],min_luck_2=80,effect_2_chance=[1,1],effect_2=[7,8],is_active=True),
        TR_Pigeon(lvl_expedition=2,coef_chance_rate=1,pigeon_type=2,src="test.png",name="pig2-2",min_atk=8,max_atk=19,min_life=24,max_life=57,min_shield=3,max_shield=5,speed=40,min_luck_1=70,effect_1_chance=[1,1,1],effect_1=[4,5,6],min_luck_2=80,effect_2_chance=[1,1],effect_2=[7,8],is_active=True),
