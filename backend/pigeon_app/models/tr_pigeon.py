...
class TR_Pigeon(models.Model):
    ...
    min_drop_minutes = models.IntegerField(default=1)
    max_drop_minutes = models.IntegerField(default=1)
    min_feathers = models.IntegerField(default=1)
    max_feathers = models.IntegerField(default=1)
